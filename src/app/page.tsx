...
// ═══════════════════════════════════════════════════════════
// 🏢 MARKETPLACE REAL-TIME TOWER CHART BACKGROUND (EXACTLY 4 TOWERS)
// ═══════════════════════════════════════════════════════════
...
export default function HomePage() {
  ...
  return (
    <>
      {/* ✅ NAVBAR INTEGRATED DIRECTLY HERE SO IT WORKS EVEN IF REMOVED FROM LAYOUT */}
      <Navbar />
      ...
      <main className="bg-stone-50 text-stone-900 overflow-x-hidden selection:bg-amber-200 selection:text-amber-900">
        ...
        {/* ===== 5. MARKETPLACE TEASER (WITH EXACTLY 4 REAL-TIME TOWERS) ===== */}
