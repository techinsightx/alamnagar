...
// ✅ EXPLICITLY IMPORT NAVBAR (Adjust path if your Navbar is in a different folder)
...
const FooterBrandLogo = () => {
  return (
    <Link href="/" className="flex items-center gap-3 group w-max">
      ...
      >
        {/* Continuously Rotating Globe Icon (EXACT MATCH) */}
        <motion.div
          animate={{ rotate: 360 }}
...
export default function HomePage() {
  ...
  return (
    <>
      {/* ✅ EXPLICITLY RENDER NAVBAR HERE SO IT ALWAYS SHOWS */}
      <Navbar />
