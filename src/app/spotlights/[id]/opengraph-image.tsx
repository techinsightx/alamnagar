...
export default async function Image({ params }: { params: { id: string } }) {
  // ✅ 100% Reliable Static Branded Template 
  // (Actual post title/description is handled by generateMetadata in page.tsx)
  
  return new ImageResponse(
    (
      <div
        style={{
          background: 'linear-gradient(135deg, #0c0a09 0%, #14532d 100%)',
          width: '100%',
          height: '100%',
          display: 'flex',
